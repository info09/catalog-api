        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayTypes = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VariantDimensionValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VariantDimensionValues_DimensionValues_DimensionValueId",
                        column: x => x.DimensionValueId,
                        principalTable: "DimensionValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VariantDimensionValues_Dimensions_DimensionId",
                        column: x => x.DimensionId,
                        principalTable: "Dimensions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantDimensionValues_DimensionId",
                table: "VariantDimensionValues",
                column: "DimensionId");

            migrationBuilder.CreateIndex(
                name: "IX_VariantDimensionValues_DimensionValueId",
                table: "VariantDimensionValues",
